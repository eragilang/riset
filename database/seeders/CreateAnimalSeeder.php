...
class CreateAnimalSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $kuda = Hewan::create([
            ...
            'nama' => 'Kuda',
            'objek' => 'img/kuda.jpeg',
            'editor' => '<div class="sketchfab-embed-wrapper"><iframe title="Horse-skeleton" frameborder="0" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true" allow="autoplay; fullscreen; xr-spatial-tracking" xr-spatial-tracking="true" execution-while-out-of-viewport="true" execution-while-not-rendered="true" web-share="true" src="https://sketchfab.com/models/f3cbabd52905467884c6392963be0d38/embed?autostart=1&internal=1&tracking=0&ui_ar=0&ui_infos=0&ui_snapshots=1&ui_stop=0&ui_theatre=1&ui_watermark=0"> </iframe></div>',
